...
export default function AppendImage({ visible, setVisible, images, setImages, id }) {
	...
	async function handleUpdate(e) {
		...
		try {
			const res = await repo.appendImage({ image: tmp });
			setSuccess(true);
	...
	return (
		<Dialog open={visible} onClose={handleClose} fullWidth>
			...
			<DialogTitle>Append image</DialogTitle>
			<DialogContent>
