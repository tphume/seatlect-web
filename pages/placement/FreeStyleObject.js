...
const FreeStyleObject = ({shapeProps,	isSelected,	onSelect,	onChange,	src, rotation, onDelete})=>{
  ...
  function testhandler(){
	...
	return(
      ...
      />
			{/* shapeProps.name */}
			<Text text={shapeProps.name} x={shapeProps.x+(shapeProps.width/2.25)-((shapeProps.name.length/2)*4)} y={shapeProps.y+(shapeProps.height/2-5)-2}  fill="black" fillEnabled fontSize={15} 
